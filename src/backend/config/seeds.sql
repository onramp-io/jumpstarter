INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('ssquarepants@krustycrab.com', 'asdkfjlkjl', 'i live in a pineapple under the sea', 'spongebob', 'squarepants');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
  VALUES ('pstar@sea.com', 'asdkfjlkjl','i live under a rock', 'patrick', 'star');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('squdward@sea.com', 'asdkfjlkjl', 'i like clarinets', 'squidward', 'something');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('obama@usa.com', 'asdkfjlkjl','i was a president', 'barrack', 'obama');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('pran@test.com', 'asdkfjlkjl','hi', 'pran', 'mag');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('idk@idk.com', 'asdkfjlkjl', 'idk what to write', 'idk', 'idk');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('beyonce@music.com', 'asdkfjlkjl', 'im awesome', 'beyonce', 'knowles');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('what@what.com', 'asdkfjlkjl', 'ok', 'ok', 'ok');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('scheeks@sea.com', 'asdkfjlkjl', 'im a squirrel that lives under water', 'sandy', 'cheeks');
INSERT INTO public.user ("email", "uid", "bio", "firstName", "lastName")
    VALUES ('test', 'test', 'asdkfjlkjl', 'test', 'test');
