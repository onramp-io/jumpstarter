...
const getTrendingProjects = async (req: NextApiRequest, res: NextApiResponse) => {
    res.send('API CALL: Get trending projects');
};

const getProjectsByCategory = async (req: NextApiRequest, res: NextApiResponse) => {
...
export default {getNewProjects, getTrendingProjects, getProjectsByCategory, getProject, updateProject, deleteProject};
