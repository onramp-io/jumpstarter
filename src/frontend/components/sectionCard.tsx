...
export const ProjectInfo = function ProjectInfoComponent<sectionCardProps>({ projectTitle, projectDescription, projectCreator }) {
  return (
    <Box>
      <Box
        align="left"
...
export const CardDescription = function CardDescriptionComponent<sectionCardProps>({ projectCreator }) {
  return (
    <Text
      color="dark-6"
    >
...
export const CreatorText = function CreatorTextComponent<sectionCardProps>({ projectCreator }) {
  return (
    <>
      <Box
        align="left"
...
const SectionCard = function sectionCardsComponent<sectionCardsProps>({ projectTitle, projectDescription, projectCreator }) {
  ...
  return (
    ...
    >
      ...
      <ProjectInfo projectTitle={projectTitle} projectDescription={projectDescription} projectCreator={projectCreator} />
    </Box>
  );
}
